...
export class OrderTypeService {
  ...
  async create(createOrderTypeDto: CreateOrderTypeDto) {
    try {
      ...
      return {
        message: `No se ha podido generar el tipo de orden médica ${error.message}`,
      };
    }
  }
  ...
  async findAll(paginationParams: PaginationParams) {
    try {
      ...
      return {
        message: `No se ha podido consultar los tipo de orden médica ${error.message}`,
      };
    }
  }
  ...
  async findOne(id: string) {
    try {
      ...
      return {
        message: `No se ha podido consultar el tipo de orden médica ${error.message}`,
      };
    }
  }
  ...
  async update(id: string, updateOrderTypeDto: UpdateOrderTypeDto) {
    try {
      ...
      return {
        message: `No se ha podido actualizar el tipo de orden médica ${error.message}`,
      };
    }
  }
}
