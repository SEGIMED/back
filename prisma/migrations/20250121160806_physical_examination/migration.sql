...
-- CreateTable
CREATE TABLE "physical_subsystem" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,

    CONSTRAINT "physical_subsystem_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "physical_examination" (
    "id" TEXT NOT NULL,
    "physical_subsystem_id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "physical_examination" ADD CONSTRAINT "physical_examination_medical_event_id_fkey" FOREIGN KEY ("medical_event_id") REFERENCES "medical_event"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "physical_examination" ADD CONSTRAINT "physical_examination_userId_fkey" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "physical_examination" ADD CONSTRAINT "physical_examination_physical_subsystem_id_fkey" FOREIGN KEY ("physical_subsystem_id") REFERENCES "physical_subsystem"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
